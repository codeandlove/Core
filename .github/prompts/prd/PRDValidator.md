...
Na podstawie analizy wygeneruj pytanie i zalecenie w formie łączonej (pytanie + zalecenie). Powinno ono dotyczyć wszelkich niejasności, potencjalnych problemów lub obszarów, w których potrzeba więcej informacji, aby stworzyć skuteczny PRD. Rozważ pytania dotyczące:
...
<pytanie>
Wymień tutaj swoje pytanie i zalecenie, dla jasności:

Przykładowo:
Czy już od startu projektu planujesz wprowadzenie płatnych subskrypcji?
