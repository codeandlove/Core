...
- Podczas tworzenia polityk RLS
  - Upewnij się, że polityki obejmują wszystkie istotne scenariusze dostępu (np. select, insert, update, delete) na podstawie cel tabeli i wrażliwość danych.
...
Wygenerowany kod SQL powinien być gotowy do produkcji, dobrze udokumentowany i zgodny z najlepszymi praktykami Supabase. Gotowy plik zapisz w formacie `.sql` w odpowiednim folderze migracji w ./supabase.
